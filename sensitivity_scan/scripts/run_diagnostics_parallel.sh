...
OUTFOLDER="/eos/home-n/npalmeri/www/DiElectron/sensitivity/fitDiagnostics_test"
...
for cat_id in $(get_all_category_ids); do
    ...
    eval "$plot_cmd" &> "$OUTFOLDER/$cat_name/diagnostics_summary_${REGION}_${FIT_TAG_LABEL}.log"
done