...
python main_background_analysis.py --full_analysis --bkg_function 4 \
                                   ...
                                   --data --tag="data_altbkg_chebyshev_withScaleSyst_IDSF" \
                                   --categories="inclusive" \
                                   --binned \
                                   --cached \
                                   --withSyst --corrected \
                                   --folder_tag="260130" \
                                   --fit_region="region1" &> logs/reweight_data_region1_altbkg_chebyshev_withScaleSyst_IDSF_binned_log &
...
python main_background_analysis.py --full_analysis --bkg_function 7 \
                                   ...
                                   --withSyst --corrected \
                                   --folder_tag="260130" \
                                   --fit_region="region2" &> logs/reweight_data_region2_altbkg_chebyshev_withScaleSyst_IDSF_binned_log &
...
python main_background_analysis.py --full_analysis --bkg_function 7 \
                                   ...
                                   --withSyst --corrected \
                                   --folder_tag="260130" \
                                   --fit_region="region0" &> logs/reweight_data_region0_altbkg_chebyshev_withScaleSyst_IDSF_binned_log &
