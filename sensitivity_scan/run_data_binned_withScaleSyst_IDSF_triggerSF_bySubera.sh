...
for era in 2022 2022EE 2023 2023BPix; do
    ...
    source scripts/run_limits_parallel.sh --cat inclusive \
                                        ...
                                        --no_caching \
                                        --region region1 \
                                        --data &> logs/260226/limits_inclusive_region1_data_altbkg_chebyshev_withScaleSyst_withMeanNuisance_IDSF_triggerSF_bySubera_${era}_binned_log
    ...
    source scripts/run_diagnostics_parallel.sh --cat inclusive \
                                            ...
                                            --data --binned \
                                            --era ${era} \
                                            --tag altbkg_chebyshev_withScaleSyst_withMeanNuisance_IDSF_triggerSF_bySubera_binned &> logs/260226/diagnostics_inclusive_region1_data_altbkg_chebyshev_withScaleSyst_withMeanNuisance_IDSF_triggerSF_bySubera_${era}_binned_log &
...
source scripts/run_limits_parallel.sh --cat inclusive \
                                      ...
                                      --era allYears \
                                       --no_caching \
                                      --region region1 \
                                      --data &> logs/260226/limits_inclusive_region1_data_altbkg_chebyshev_withScaleSyst_withMeanNuisance_IDSF_triggerSF_bySubera_allYears_binned_log
...
for era in 2022 2022EE 2023 2023BPix; do
    ...
    source scripts/run_limits_parallel.sh --cat inclusive \
                                        ...
                                        --no_caching \
                                        --region region2 \
                                        --data &> logs/260226/limits_inclusive_region2_data_altbkg_chebyshev_withScaleSyst_withMeanNuisance_IDSF_triggerSF_bySubera_${era}_binned_log
    ...
    source scripts/run_diagnostics_parallel.sh --cat inclusive \
                                            ...
                                            --data --binned \
                                            --era ${era} \
                                            --tag altbkg_chebyshev_withScaleSyst_withMeanNuisance_IDSF_triggerSF_bySubera_binned &> logs/260226/diagnostics_inclusive_region2_data_altbkg_chebyshev_withScaleSyst_withMeanNuisance_IDSF_triggerSF_bySubera_${era}_binned_log &
...
source scripts/run_limits_parallel.sh --cat inclusive \
                                      ...
                                      --no_caching \
                                      --region region2 \
                                      --data &> logs/260226/limits_inclusive_region2_data_altbkg_chebyshev_withScaleSyst_withMeanNuisance_IDSF_triggerSF_bySubera_allYears_binned_log
...
for era in 2022 2022EE 2023 2023BPix; do
    ...
    source scripts/run_limits_parallel.sh --cat inclusive \
                                        ...
                                        --no_caching \
                                        --region region0 \
                                        --data &> logs/260226/limits_inclusive_region0_data_altbkg_chebyshev_withScaleSyst_withMeanNuisance_IDSF_triggerSF_bySubera_${era}_binned_log
    ...
    source scripts/run_diagnostics_parallel.sh --cat inclusive \
                                            ...
                                            --data --binned \
                                            --era ${era} \
                                            --tag altbkg_chebyshev_withScaleSyst_withMeanNuisance_IDSF_triggerSF_bySubera_binned &> logs/260226/diagnostics_inclusive_region0_data_altbkg_chebyshev_withScaleSyst_withMeanNuisance_IDSF_triggerSF_bySubera_${era}_binned_log &
done
...
source scripts/run_limits_parallel.sh --cat inclusive \
                                      ...
                                      --no_caching \
                                      --region region0 \
                                      --data &> logs/260226/limits_inclusive_region0_data_altbkg_chebyshev_withScaleSyst_withMeanNuisance_IDSF_triggerSF_bySubera_allYears_binned_log
